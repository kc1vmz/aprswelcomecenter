...
import com.kc1vmz.aprswc.database.AnnouncementRepository;
...
public class AnnouncementAccessor {
    ...
    public Mono<Announcement> create(Announcement value) {
        value.setId(null);
        return Mono.fromCallable(() -> repository.save(value)).subscribeOn(Schedulers.boundedElastic());
    }

    public Mono<Announcement> replace(UUID id, Announcement value) {
        return findById(id)
