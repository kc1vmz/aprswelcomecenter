...
public class APRSTCPIPListenerAccessor {
    ...
    private static final String PACKET_PROCESSOR_ID = "APRS_KISS_TCPIP";
    ...
    private void connectAndListenMain(ApplicationSettings applicationSettings) throws InterruptedException {
        ...
        try {
            ...
            client.connect(applicationSettings.getKissHost(), Integer.parseInt(applicationSettings.getKissPort()));
